...
#import "../Models/Salmon.h"
@class OperationError;

/**
 * An protocol provides access to all Polymorphisms operations
 */
@protocol PolymorphismsProtocol
...
@interface Polymorphisms : NSObject <PolymorphismsProtocol>
