...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AzureClientRuntime.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/vladimir-shcherbakov/AzureClientRuntime'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'vladimir-shcherbakov' => 'vlashch@microsoft.com' }
  s.source           = { :git => 'https://github.com/vladimir-shcherbakov/AzureClientRuntime.git', :tag => s.version.to_s }
